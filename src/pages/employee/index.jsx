...
export default function EmployeeHome({isConnected, schedule, email}) {
        ...
        <>  
            ...
            <div className="flex flex-col">
                <div className="flex">
                    ...
                    <Link href={{pathname: "/employee/settings/profile", query: {email: email}}} className="mt-24 hover:text-primary hover:rotate-90 duration-300 w-fit h-fit">
